...
| `fm-control.sh`          | Agent lifecycle control plane: allowlisted `interrupt`, `exit`, transactional `relaunch`, and record-correcting `rebind` verbs for an exact task id ([agent-control.md](agent-control.md)) |
