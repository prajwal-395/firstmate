...
| `fm-tracker.sh`          | Own firstmate's GitHub Issues project layer: typed tickets, blocking edges, frontier, claims, answers, comments, validation, the comment wake, and the task tickets the dispatch and the cleanup file and close |
