...
# script fixes. Instead this creates a non-visible tracked herdr tab/
...
#
# Supported backends: herdr only. The removed tmux, zellij, orca, and cmux
# adapters survive only in git history.
#
