...
# optional pre-captured plain output used only by the grok, rovo, and agy arms;
# when absent each captures through fm_backend_capture if available, else
# reports unknown capture-failed.
