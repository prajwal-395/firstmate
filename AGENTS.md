...
- **direct-PR** has the worker push and open a PR without the no-mistakes pipeline, wait for the check set to reach a complete verdict, then waits for the configured merge authority.
