...
#   (s) the USAGE-CAP override: an opencode lane the vendor holds in retry with
...
reset_fakes() {
  ...
  export FM_FAKE_HERDR_BUSY FM_FAKE_HERDR_BUSY_TEXT FM_FAKE_HERDR_DIALOG FM_FAKE_HERDR_MISSING FM_FAKE_HERDR_READ_FAIL FM_FAKE_HERDR_HUSK FM_FAKE_HERDR_AGENT_STATUS FM_FAKE_HERDR_PROCESS FM_FAKE_HERDR_SHELL_PID FM_FAKE_CI_LOGS
...
# (s) the usage-cap override: a capped opencode lane never fails - the vendor
