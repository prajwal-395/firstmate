...
# agy model switch the live ladder is built on: the descent that moves a worker
# down a spent rung. (The climb half went with #40.)
#
...
fm_live_gate opt-in FM_AGY_MODEL_SWITCH_LIVE_E2E agy herdr jq
